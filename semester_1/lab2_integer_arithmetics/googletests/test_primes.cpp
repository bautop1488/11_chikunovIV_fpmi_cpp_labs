...
TEST(PrimesTest, InvalidRange) {
    EXPECT_THROW(FindPrimesInRange(10, 1), std::out_of_range); 
    EXPECT_THROW(FindPrimesInRange(1000, -13), std::out_of_range); 
    EXPECT_THROW(FindPrimesInRange(-10, -214), std::out_of_range); 
}
